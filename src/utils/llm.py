...
def call_llm(
    ...
    for attempt in range(max_retries):
        try:
            ...
            # For non-JSON support models or Bedrock, we need to extract and parse the JSON manually
            if model_info and (not model_info.has_json_mode() or model_info.provider == ModelProvider.BEDROCK):
